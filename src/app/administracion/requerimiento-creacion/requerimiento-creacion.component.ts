...
@Component({
  selector: 'app-requerimiento-creacion',
  templateUrl: './requerimiento-creacion.component.html',
  styleUrls: ['./requerimiento-creacion.component.css']
})
export class RequerimientoCreacionComponent implements OnInit {
  ...
  getRequerimientos () {
    this.requerimientoService.getRequerimientosPorCondominioYEstado(this._codigoCondominio, 0).subscribe((data) => {

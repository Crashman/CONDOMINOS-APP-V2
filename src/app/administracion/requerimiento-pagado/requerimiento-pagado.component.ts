...
@Component({
  selector: 'app-requerimiento-pagado',
  templateUrl: './requerimiento-pagado.component.html',
  styleUrls: ['./requerimiento-pagado.component.css']
})
export class RequerimientoPagadoComponent implements OnInit {
  ...
  getRequerimientos () {
    this.requerimientoService.getRequerimientosPorCondominioYEstado(this._codigoCondominio, 2).subscribe((data) => {

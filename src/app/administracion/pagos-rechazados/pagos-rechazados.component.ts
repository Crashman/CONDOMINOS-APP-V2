...
@Component({
  selector: 'app-pagos-rechazados',
  templateUrl: './pagos-rechazados.component.html',
  styleUrls: ['./pagos-rechazados.component.css']
})
export class PagosRechazadosComponent implements OnInit {
  ...
  /*Rechazado*/
  getPagos() {
    this.pagoService.getPagosPorCondominio(this._codigoCondominio, 2).subscribe((data) => {

...
@Component({
  selector: 'app-mis-pagos-rechazados',
  templateUrl: './mis-pagos-rechazados.component.html',
  styleUrls: ['./mis-pagos-rechazados.component.css']
})
export class MisPagosRechazadosComponent implements OnInit {
  ...
  /*Rechazados*/
  getPagos() {
    this.pagoService.getPagosPorCondomino(this._codigoUsuario, 2).subscribe((data) => {

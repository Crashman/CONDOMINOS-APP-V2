...
@Component({
  selector: 'app-requerimientos-por-pagar',
  templateUrl: './requerimientos-por-pagar.component.html',
  styleUrls: ['./requerimientos-por-pagar.component.css'],
})
export class RequerimientosPorPagarComponent implements OnInit {
  ...
  getRequerimientos() {
    ...
    console.log(Requerimiento.codigoUsuario);
    this.requerimientoService
      .getRequerimientosPorCondominoYEstado(/*this._codigoUsuario, 0)*/ Requerimiento)
      .subscribe((data) => {

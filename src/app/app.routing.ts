...
export const appRoutes: Route[] = [
    ...
    // Landing routes
    {
     ...
     // Auth routes for guests
     {
        ...
        canActivateChild: [AuthGuard],
        children: [
            {path: 'first-login', loadChildren: () => import('app/modules/auth/first-login/first-login.module').then(m => m.AuthFirstLoginModule)}
        ]
    },
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
             ...
             // Dashboards
             {path: 'CAPP', children: [
                {path: 'administracion', loadChildren: () => import('app/administracion/administracion.module').then(m => m.AdministracionModule)},
                {path: 'condomino', loadChildren: () => import('app/condomino/condomino.module').then(m => m.CondominoModule)},
                {path: 'mantenimiento', loadChildren: () => import('app/mantenimiento/mantenimiento.module').then(m => m.MantenimientoModule)},
            ]},
